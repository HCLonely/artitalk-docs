...
::: warning 历史说明
以下内容记录旧版 Artitalk 的发布历史，其中 LeanCloud、`appId`、`appKey` 和 Class 配置仅适用于当时版本，不是当前 Vercel 后端的安装说明。当前用法请查看[使用文档](/doc/)。
:::
...
* 因为之前的更新日志过于杂乱，所以放在了另一个页面，如果想查看可以[点击这里](/prerelease/)
